...
b_A_C <- 0.04   # Between-region speciation rate from range {A,C} to {A} and {C}
b_B_C <- 0.04   # Between-region speciation rate from range {B,C} to {B} and {C}
b_A_BC <- 0.04  # Between-region speciation rate from range {A,B,C} to {A} and {B,C}
b_B_AC <- 0.04  # Between-region speciation rate from range {A,B,C} to {B} and {A,C}
b_C_AB <- 0.04  # Between-region speciation rate from range {A,B,C} to {C} and {A,B}
