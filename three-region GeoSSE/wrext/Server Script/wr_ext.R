...
e_A <- 0.01   # Extinction rate in region A
e_B <- 0.02   # Extinction rate in region B
e_C <- 0.025  # Extinction rate in region A

e_vec <- c(e_A,e_B,e_C)

# Region-specific dispersal rates 
d_AB <- 0 # Dispersal rate from region A to region B
d_BA <- 0 # Dispersal rate from region B to region A
d_AC <- 0 # Dispersal rate from region A to region C
d_CA <- 0 # Dispersal rate from region C to region A
d_BC <- 0 # Dispersal rate from region B to region C
d_CB <- 0 # Dispersal rate from region C to region B
