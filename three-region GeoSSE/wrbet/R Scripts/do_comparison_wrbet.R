...
# Compute the average across non-extinct trajectories for each species range (from MASTER)
pA_aver = c()
pB_aver = c()
pC_aver = c()
pAB_aver = c()
...
# title('GeoSSE: Within-Region and Between-Region Speciation', outer = TRUE,line=-2)
