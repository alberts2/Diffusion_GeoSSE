# This code combines all the simulation replicates generated using geosse_all_A.sh, geosse_all_B.sh,...,geosse_all_ABC.sh
...
#
N_combined_list <- vector("list",7)
N_combined_list<- append(N_combined_list,N_combined_list_1,after = 0)
N_combined_list<- append(N_combined_list,N_combined_list_2,after = 150)
N_combined_list<- append(N_combined_list,N_combined_list_3,after = 300)
N_combined_list<- append(N_combined_list,N_combined_list_4,after = 450)
N_combined_list<- append(N_combined_list,N_combined_list_5,after = 600)
N_combined_list<- append(N_combined_list,N_combined_list_6,after = 750)
N_combined_list<- append(N_combined_list,N_combined_list_7,after = 900)
N_combined_list <- N_combined_list[lapply(N_combined_list,length)>0]

#
N_t_total_list <- vector("list",7)
N_t_total_list<- append(N_t_total_list,N_t_total_list_1,after = 0)
N_t_total_list<- append(N_t_total_list,N_t_total_list_2,after = 150)
N_t_total_list<- append(N_t_total_list,N_t_total_list_3,after = 300)
N_t_total_list<- append(N_t_total_list,N_t_total_list_4,after = 450)
N_t_total_list<- append(N_t_total_list,N_t_total_list_5,after = 600)
N_t_total_list<- append(N_t_total_list,N_t_total_list_6,after = 750)
N_t_total_list<- append(N_t_total_list,N_t_total_list_7,after = 900)
N_t_total_list <- N_t_total_list[lapply(N_t_total_list,length)>0]

#
pA_theor_list <- vector("list",7)
pA_theor_list<- append(pA_theor_list,pA_theor_list_1,after = 0)
pA_theor_list<- append(pA_theor_list,pA_theor_list_2,after = 150)
pA_theor_list<- append(pA_theor_list,pA_theor_list_3,after = 300)
pA_theor_list<- append(pA_theor_list,pA_theor_list_4,after = 450)
pA_theor_list<- append(pA_theor_list,pA_theor_list_5,after = 600)
pA_theor_list<- append(pA_theor_list,pA_theor_list_6,after = 750)
pA_theor_list<- append(pA_theor_list,pA_theor_list_7,after = 900)
pA_theor_list <- pA_theor_list[lapply(pA_theor_list,length)>0]

#
pB_theor_list <- vector("list",7)
pB_theor_list<- append(pB_theor_list,pB_theor_list_1,after = 0)
pB_theor_list<- append(pB_theor_list,pB_theor_list_2,after = 150)
pB_theor_list<- append(pB_theor_list,pB_theor_list_3,after = 300)
pB_theor_list<- append(pB_theor_list,pB_theor_list_4,after = 450)
pB_theor_list<- append(pB_theor_list,pB_theor_list_5,after = 600)
pB_theor_list<- append(pB_theor_list,pB_theor_list_6,after = 750)
pB_theor_list<- append(pB_theor_list,pB_theor_list_7,after = 900)
pB_theor_list <- pB_theor_list[lapply(pB_theor_list,length)>0]

#
pC_theor_list <- vector("list",7)
pC_theor_list<- append(pC_theor_list,pC_theor_list_1,after = 0)
pC_theor_list<- append(pC_theor_list,pC_theor_list_2,after = 150)
pC_theor_list<- append(pC_theor_list,pC_theor_list_3,after = 300)
pC_theor_list<- append(pC_theor_list,pC_theor_list_4,after = 450)
pC_theor_list<- append(pC_theor_list,pC_theor_list_5,after = 600)
pC_theor_list<- append(pC_theor_list,pC_theor_list_6,after = 750)
pC_theor_list<- append(pC_theor_list,pC_theor_list_7,after = 900)
pC_theor_list <- pC_theor_list[lapply(pC_theor_list,length)>0]

#
pAB_theor_list <- vector("list",7)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_1,after = 0)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_2,after = 150)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_3,after = 300)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_4,after = 450)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_5,after = 600)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_6,after = 750)
pAB_theor_list<- append(pAB_theor_list,pAB_theor_list_7,after = 900)
pAB_theor_list <- pAB_theor_list[lapply(pAB_theor_list,length)>0]

#
pAC_theor_list <- vector("list",7)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_1,after = 0)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_2,after = 150)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_3,after = 300)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_4,after = 450)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_5,after = 600)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_6,after = 750)
pAC_theor_list<- append(pAC_theor_list,pAC_theor_list_7,after = 900)
pAC_theor_list <- pAC_theor_list[lapply(pAC_theor_list,length)>0]

#
pBC_theor_list <- vector("list",7)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_1,after = 0)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_2,after = 150)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_3,after = 300)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_4,after = 450)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_5,after = 600)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_6,after = 750)
pBC_theor_list<- append(pBC_theor_list,pBC_theor_list_7,after = 900)
pBC_theor_list <- pBC_theor_list[lapply(pBC_theor_list,length)>0]

#
pABC_theor_list <- vector("list",7)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_1,after = 0)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_2,after = 150)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_3,after = 300)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_4,after = 450)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_5,after = 600)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_6,after = 750)
pABC_theor_list<- append(pABC_theor_list,pABC_theor_list_7,after = 900)
