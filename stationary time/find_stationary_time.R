...
load(file = "Dataset_1/pia_init.RData")
load(file = "Dataset_1/pib_init.RData")
load(file = "Dataset_1/piab_init.RData")
load(file = "Dataset_1/wa.RData")
load(file = "Dataset_1/wb.RData")
load(file = "Dataset_1/ea.RData")
load(file = "Dataset_1/eb.RData")
load(file = "Dataset_1/bab.RData")
load(file = "Dataset_1/dab.RData")
load(file = "Dataset_1/dba.RData")
...
load(file = "Dataset_2/pia_init.RData")
load(file = "Dataset_2/pib_init.RData")
load(file = "Dataset_2/piab_init.RData")
load(file = "Dataset_2/wa.RData")
load(file = "Dataset_2/wb.RData")
load(file = "Dataset_2/ea.RData")
load(file = "Dataset_2/eb.RData")
load(file = "Dataset_2/bab.RData")
load(file = "Dataset_2/dab.RData")
load(file = "Dataset_2/dba.RData")
find_stationary_time(wa,wb,ea,eb,dab,dba,bab,pia_init,pib_init,250,1000,10^-9)

# Load pre-computed initial frequencies and rate parameters (Figure 8 left panel)
load(file = "Dataset_3/pia_init.RData")
load(file = "Dataset_3/pib_init.RData")
load(file = "Dataset_3/piab_init.RData")
load(file = "Dataset_3/wa.RData")
load(file = "Dataset_3/wb.RData")
load(file = "Dataset_3/ea.RData")
load(file = "Dataset_3/eb.RData")
load(file = "Dataset_3/bab.RData")
load(file = "Dataset_3/dab.RData")
load(file = "Dataset_3/dba.RData")
...
load(file = "Dataset_4/pia_init.RData")
load(file = "Dataset_4/pib_init.RData")
load(file = "Dataset_4/piab_init.RData")
load(file = "Dataset_4/wa.RData")
load(file = "Dataset_4/wb.RData")
load(file = "Dataset_4/ea.RData")
load(file = "Dataset_4/eb.RData")
load(file = "Dataset_4/bab.RData")
load(file = "Dataset_4/dab.RData")
load(file = "Dataset_4/dba.RData")
